"use strict";exports.__esModule=true;exports.getPageChunks=getPageChunks;exports.ChunkGraphPlugin=void 0;var _constants=require("next-server/constants");var _path=_interopRequireDefault(require("path"));var _querystring=require("querystring");function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}const manifest={sharedFiles:[],pages:{},pageChunks:{},chunks:{}};const pageModules={};function getPageChunks(page){if(!manifest.pages[page]&&!pageModules[page]){return;}const external=new Set();// from node_modules
