...
class Server {
    ...
    generateRoutes() {
        ...
        if (this.nextConfig.experimental.publicDirectory &&
            fs_1.default.existsSync(this.publicDir)) {
        ...
        return this.findPageComponents(pathname, query)
            ...
            for (const dynamicRoute of this.dynamicRoutes) {
                ...
                return this.findPageComponents(dynamicRoute.page, query).then(result => {
                    return this.renderToHTMLWithComponents(req, res, dynamicRoute.page, Object.assign({}, query, params), result, Object.assign({}, this.renderOpts, { amphtml, hasAmp, dataOnly }));
                });
            }
            return Promise.reject(err);
        })
